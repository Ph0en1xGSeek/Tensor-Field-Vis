...
/* Computing MAX */
			i__2 = maxwrk, i__3 = (*n << 1) + (*n - 1) * ilaenv_(&
				c__1, "CUNGBR", "P", n, n, n, &c_n1, (ftnlen)6, (ftnlen)1);
			maxwrk = max(i__2,i__3);
		    }
		    minwrk = *n * 3;
		} else if (wntuo && wntvn) {
...
/* Computing MAX */
		    i__2 = wrkbl, i__3 = (*n << 1) + *n * ilaenv_(&c__1, 
			    "CUNGBR", "Q", n, n, n, &c_n1, (ftnlen)6, (ftnlen)1);
		    wrkbl = max(i__2,i__3);
/* Computing MAX */
...
/* Computing MAX */
			i__2 = maxwrk, i__3 = (*m << 1) + *m * ilaenv_(&c__1, 
				"CUNGBR", "Q", m, m, m, &c_n1, (ftnlen)6, (ftnlen)1);
			maxwrk = max(i__2,i__3);
		    }
		    minwrk = *m * 3;
		} else if (wntvo && wntun) {
...
/* Computing MAX */
		    i__2 = wrkbl, i__3 = (*m << 1) + (*m - 1) * ilaenv_(&c__1,
			     "CUNGBR", "P", m, m, m, &c_n1, (ftnlen)6, (ftnlen)1);
		    wrkbl = max(i__2,i__3);
/* Computing MAX */
...
/* Computing MAX */
		    i__2 = maxwrk, i__3 = (*m << 1) + (*m - 1) * ilaenv_(&
			    c__1, "CUNGBR", "Q", m, m, m, &c_n1, (ftnlen)6, (ftnlen)1);
		    maxwrk = max(i__2,i__3);
		}
		minwrk = (*m << 1) + *n;
	    }
