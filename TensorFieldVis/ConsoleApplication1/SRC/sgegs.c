...
/* Subroutine */ int sgegs_(char *jobvsl, char *jobvsr, integer *n, real *a, 
	...
	*beta, real *vsl, integer *ldvsl, real *vsr, integer *ldvsr, real * 	work, integer *lwork, integer *info  	)
{
/*  -- LAPACK driver routine (version 3.1) --   
    ...
    extern /* Subroutine */ int sggbak_(char *, char *, integer *, integer *,  	    integer *, real *, real *, integer *, real *, integer *, integer * 	    ), sggbal_(char *, integer *, real *, integer *, 
