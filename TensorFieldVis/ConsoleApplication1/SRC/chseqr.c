...
/* Subroutine */ int chseqr_(char *job, char *compz, integer *n, integer *ilo,
	 integer *ihi, complex *h__, integer *ldh, complex *w, complex *z__,  	integer *ldz, complex *work, integer *lwork, integer *info  	)
{
...
/*        ==== CLAHQR/CLAQR0 crossover point ====   
   ...
   Writing concatenation */
	...
	nmin = ilaenv_(&c__1, "CHSEQR", ch__1, n, ilo, ihi, lwork, (ftnlen)6, 
		(ftnlen)2);
	nmin = max(11,nmin);
