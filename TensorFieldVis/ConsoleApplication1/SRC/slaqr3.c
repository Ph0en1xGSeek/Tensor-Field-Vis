...
/*     ==== Convert to spike-triangular form.  (In case of a   
    ...
    slaset_("A", &jw, &jw, &c_b15, &c_b16, &v[v_offset], ldv);
...
/*           ==== Reflect spike back into lower triangle ==== */
	    ...
	    i__1 = jw - 2;
	    i__2 = jw - 2;
	    slaset_("L", &i__1, &i__2, &c_b15, &c_b15, &t[t_dim1 + 3], ldt);
...
/*        ==== Accumulate orthogonal matrix in order update   
	...
	if (*ns > 1 && s != 0.f) {
	    ...
	    sorghr_(&jw, &c__1, ns, &t[t_offset], ldt, &work[1], &work[jw + 1]
		    , &i__1, &info);
	    sgemm_("N", "N", &jw, ns, ns, &c_b16, &v[v_offset], ldv, &t[
...
/* Computing MIN */
	    ...
	    kln = min(i__3,i__4);
	    sgemm_("N", "N", &kln, &jw, &jw, &c_b16, &h__[krow + kwtop * 
...
/* Computing MIN */
		...
		kln = min(i__3,i__4);
		sgemm_("C", "N", &jw, &kln, &jw, &c_b16, &v[v_offset], ldv, &
...
/* Computing MIN */
		...
		kln = min(i__3,i__4);
		sgemm_("N", "N", &kln, &jw, &jw, &c_b16, &z__[krow + kwtop * 
