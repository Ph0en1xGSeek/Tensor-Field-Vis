...
/*  -- LAPACK routine (version 3.1) --   
    ...
    extern /* Subroutine */ int zgeqrf_(integer *, integer *, doublecomplex *, 	     integer *, doublecomplex *, doublecomplex *, integer *, integer * 	    ), zgerqf_(integer *, integer *, doublecomplex *, integer *, 
